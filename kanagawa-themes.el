...
(eval-when-compile
  (defvar kanagawa-themes-color-palette-list
    '((sumi-ink-0 "#16161D")
      ...
      (paper-white-0 "#d3c6af")
      (paper-white-1 "#dacdb8")
      (paper-white-2 "#e3d5bc")
      (paper-white-3 "#f0e4c8")
      (paper-white-4 "#ecddbb")
      (paper-white-5 "#e2cfa0"))
...
(kanagawa-themes--define-variant-colors
  ...
  `((fg ,lotus-ink-1)
    ...
    (bg-dim ,paper-white-1)
    (bg-gutter ,paper-white-4)
    ...
    (float-fg ,lotus-ink-2)
    (float-bg ,paper-white-0)
    (float-fg-border ,lotus-gray-2)
    (float-bg-border ,paper-white-0)
